...
const DonationForm = () => {
  ...
  const handleConfirmationSubmit = async() => {
    ...
    const formData={
      ...
      stationaryQuantityRequired: recipientRequestDetails.stationaryQuantityRequired
    };
  ...
  const handleChange = (e) => {
    setRecipientRequestDetails({...recipientRequestDetails, [e.target.name]:e.target.value});      
  };
    ...
    >
      <Form onSubmit={handleSubmit}>
        <Form.Group controlId="foodQty" className="mb-5">
          <Form.Label>Enter raw food quantity</Form.Label>
          <Form.Control
            type="number"
            min={0}
        ...
        <Form.Group controlId="stationeryQty" className="mb-5">
          <Form.Label>Stationary quantity</Form.Label>
          <Form.Control
            type="number"
            min={0}
        ...
        <Form.Group controlId="clothingQty" className="mb-5">
          <Form.Label>Clothing quantity</Form.Label>
          <Form.Control
            type="number"
            min={0}
        ...
        >
          ...
          <Modal.Body>
            <p>
              Please confirm that you want to generate request for
              following items:
            </p>
            <ul>
              <li>
