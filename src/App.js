      ...
      <>
        <BrowserRouter>
          <Routes>
            ...
            <Route path="/donorEditProfile" element={<DonorEditProfile></DonorEditProfile>}></Route>
            <Route path='/donationForm' element={<DonationLandingPage></DonationLandingPage>}></Route>
            <Route path='/donordonationdetails' element={<DonorDonationDetails></DonorDonationDetails>}></Route>
            
            {/* admin paths below */}
            {/* <Route path='/adminLogin' element={<AdminLoginForm></AdminLoginForm>}></Route> */}
            <Route path='/adminDonationAssign' element={<AdminDonationAssign></AdminDonationAssign>}></Route>
            <Route path='/adminDonationAlreadyAssign' element={<AdminDonationAlreadyAssign></AdminDonationAlreadyAssign>}></Route>
            <Route path='/adminRecipientVerification' element={<AdminRecipientVerification></AdminRecipientVerification>}></Route>
            <Route path='/adminRecipientsList' element={<AdminRecipientDetails></AdminRecipientDetails>}></Route>

            {/* volunteer paths below */}
            <Route path="/volunteerRegistrationForm" element={<VolunteerRegistrationForm></VolunteerRegistrationForm>}></Route>
            {/* <Route path="/volunteerLoginForm" element={<VolunteerLoginForm></VolunteerLoginForm>}></Route> */}
            <Route path="/volunteerHome" element={<VolunteerHome></VolunteerHome>}></Route>
            <Route path="/volunteerProfile" element={<VolunteerProfile></VolunteerProfile>}></Route>
            <Route path="/volunteerEditProfile" element={<VolunteerEditProfile></VolunteerEditProfile>}></Route>
            <Route path='/volunteerDonationAssign' element={<VolunteerDonationDetails></VolunteerDonationDetails>}></Route>
            <Route path='/volunteerDonationToBeCollected' element={<VolunteerDonationToBeCollected></VolunteerDonationToBeCollected>}></Route>
            <Route path='/volunteerDonationIsCollected' element={<VolunteerDonationIsCollected></VolunteerDonationIsCollected>}></Route> 

            {/* recipient paths below */}
            <Route path='/recipientRegistrationForm' element={<RecipientRegistrationForm></RecipientRegistrationForm>}></Route>
            {/* <Route path='/recipientLoginForm' element={<RecipientLoginForm></RecipientLoginForm>}></Route> */}
            <Route path='/recipientHome' element={<RecipientHome></RecipientHome>}></Route>
            <Route path='/recipientProfile' element={<RecipientProfile></RecipientProfile>}></Route>
            {/* <Route path='/recipientEditProfile' element={<RecipientProfile></RecipientProfile>}></Route> */}
            <Route path='/recipientRequestForm' element={<RecipientRequestLandingPage></RecipientRequestLandingPage>}></Route>
            <Route path='/recipientViewRequestDetails' element={<RecipientRequestDetails></RecipientRequestDetails>}></Route>
            </Routes>
        </BrowserRouter>
      </>    
  );
